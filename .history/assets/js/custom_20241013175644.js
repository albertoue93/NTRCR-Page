...
window.addEventListener('resize', function() {
    ...
    if (window.innerWidth >= 992) {
      // Pantallas grandes: asegurarse de que el menú está visible y sin scroll
      menu.style.maxHeight = 'none';
      menu.style.overflowY = 'visible';
    } else {
      // Pantallas pequeñas: aplicar scroll y altura limitada
      menu.style.maxHeight = '300px';
      menu.style.overflowY = 'auto';
    }
  });
  
  // Ejecutar la función al cargar la página para aplicar los estilos correctos
