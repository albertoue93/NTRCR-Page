...
function filterResults() {
	...
	// Selecciona el toggle y el body
    ...
    function toggleDarkMode() {
        ...
        // Actualiza el ícono en el toggle según el modo actual
        if (body.classList.contains('dark-mode')) {
            toggleButton.textContent = '☀️'; // Icono de sol para indicar modo claro
            localStorage.setItem('theme', 'dark-mode');
        } else {
            toggleButton.textContent = '🌙'; // Icono de luna para indicar modo oscuro
            localStorage.setItem('theme', 'light-mode');
        }
    }
    
    // Configura el tema inicial según la preferencia almacenada en localStorage
    ...
    // Escucha el clic en el toggle para cambiar el modo
